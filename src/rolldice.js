...
function RollingDice(){
    ...
    const [rolledDice2, setRolledDice2] = useState(0);
    ...
    const roll = () =>{
        ...
        setRolledDice2(newRandomNumber2);

    }
    return(
        <div>
            <img src={list[rolledDice1-1]} width="100" height="100"/> 	&nbsp;
            <img src={list[rolledDice2-1]} width="100" height="100"/> 	&nbsp;
            <button onClick={roll} style={{backgroundColor:'pink'}}> Sallayınız</button> 
            {rolledDice1 === rolledDice2 && <h2> Her iki zar birbirine eşit olduğu için kazandınız!</h2>}
